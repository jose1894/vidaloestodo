        ...
        <div class="container-fluid">
            <div class="section-header-2">
                ...
                <a href="{{ route('products.category', ['id' => $key->id, 'slug' => slug($key->name)]) }}"
                    class="custom-button theme btn-sm">@lang('View All Products')</a>
            </div>
            <div class="m--15">
                                            ...
                                            @if (isset($item->offer))
                                                @if ($item->offer['activeOffer'])
                                                    @if ($item->offer['activeOffer']['discount_type'] == 2)
                                                        <span class="text-white bg-danger tag-discount">
                                            ...
                                            <div class="product-content">
                                                <div class="product-before-content">
                                                    ...
                                                    <div class="stock-argo">
                                                        ({{ $item['stocks']->count() > 0 ? $item['stocks'][0]->quantity : '0' }}
                                                        @lang('product avaliable') )</div>
                                                    ...
                                                    <div class="iva-argo">
                                                        {{ $item->iva == 1 ? 'Precio incluye IVA' : 'Exento' }}</div>
                                                    ...
                                                    @else
                                                        @if ($discount > 0)
                                                            <span class="text-danger">
                                                                {{ getAmount($item->precioBaseIva - $discount, 2) * $rate }}
                                                                {{ $moneda == 'Euros' ? '€. ' : 'Bs. ' }}
                                                            </span>
                                                ...
                                                <div class="argo-count">
                                                    ...
                                                    <div class="cart-plus-minus quantity">
                                                        ...
                                                        <select style="display: none;width: 80px;height: 40px;"
                                                            ...
                                                            type="number" id="quantity{{ $item['id'] }}"
                                                            name="quantity" step="1" min="1"
                                                            class="integer-validation quantity{{ $item['id'] }} form-control">
                                                            @if ($quantity > 0)
