...
<head>
    ...
    <link rel="stylesheet" href="{{ asset($activeTemplateTrue.'css/product-item.css?v=0.0.4') }}">
    <link rel="stylesheet" href="{{ asset($activeTemplateTrue.'css/category-slider.css?v=0.0.4') }}">
...
<body style="padding-top: 134.2px;">
    <div id="home">
        ...
        <a href="https://wa.me/5804124431159?text=" class="whatsapp" target="_blank">
