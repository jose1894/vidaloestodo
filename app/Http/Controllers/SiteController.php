...
class SiteController extends Controller
{
    ...
    public function megasoft(Request $request){
        $curl = curl_init();
        dd("https://paytest.megasoft.com.ve/payment/action/paymentgatewayuniversal-prereg?cod_afiliacion=2606202301&factura=1265&monto=" . $request->total);
        ...
        curl_setopt_array($curl, [
            ...
            CURLOPT_POSTFIELDS => "",
            CURLOPT_COOKIE => "JSESSIONID=22F8EC805F50F4B1FD0ADE2E26311490",
            CURLOPT_HTTPHEADER => [
                "Authorization: Basic d3BhZ29zOkNhcmFjYXMxLg=="
            ],
        ]);
